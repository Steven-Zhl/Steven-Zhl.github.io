...
$$\int_C f(z)\text{d}z=\int^b_a f\left[z(t)\right]z'(d)\text{d}t$$

> 其中，$z'(t)=x'(t)+\mathrm{i}y'(t)$
...
* **柯西基本定理**
  ...
  <img alt="湖北省1" src="/images/数学/湖北省1.png" style="height: 50%; max-height: 100%">
...
* **引理**
  ...
  <img alt="湖北省2" src="/images/数学/湖北省2.png" style="height: 50%; max-height: 100%">
...
* **引理2**
  ...
  <img alt="陕西省1" src="/images/数学/陕西省1.png" style="height: 50%; max-height: 100%">
...
* **闭路变形原理**
  ...
  <img alt="闭路变形原理" src="/images/数学/闭路变形原理.png" style="height: 50%; max-height: 100%">
...
* 公式描述：设多连域$D$的边界为$C=C_0+C_1^-+C_2^-+...+C_n^-$，函数$f(z)$在$D$内解析，在$C$上连续，则
  ...
  $$\text{或}\oint_{C_0}f(z)\text{d}z=\oint_{C_1}f(z)\text{d}z+\oint_{C_2}f(z)\text{d}z+...+\oint_{C_n}f(z)\text{d}z$$
## 3.4 解析函数的高阶导数
## 参考资料

...
subtitle: 我的Jekyll博客都是基于H5模板改的，算是大概搞清了，因此我觉得我应该有资格聊一聊Jekyll吧。
date: 2023-07-20 17:00:00 +0800
cover: "/images/Jekyll/1_从基础聊起.jpg"
tag:
  - Jekyll
  - 简单介绍
category: Jekyll
...
* 在Windows上配置就要麻烦一些，主要原因是需要用安装程序(RubyInstaller)来提供Ruby环境，并且需要MSYS2提供编译环境(没错，ruby也是基于C的)。

---
layout: post
title: "[Python开发向] 1 关于第三方库"
subtitle: 其实就是pip和conda啦
date: 2023-07-25 18:00:00 +0800
cover: "/images/Python开发向/1_关于第三方库.jpg"
tag:
  - Python
  - pip
  - conda
category: Python开发向
---
> Python之所以如此流行，很大程度上因为第三方库足够多，有大量的开发者维护和开发Python库。这篇文章聊一聊最常见的两个包管理器，它们的用法，以及一些小技巧。
...
* 包管理器是一种非常常见的工具，比较新的语言几乎都有自己的包管理器。它能够让你轻松安装第三方库，以便于你利用别人的工作成果，而不是重复造轮子。

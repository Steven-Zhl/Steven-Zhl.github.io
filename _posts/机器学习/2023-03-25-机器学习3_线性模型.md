...
> 均方误差：[戳这里回顾一下](/机器学习/2023/03/14/机器学习2_模型评估与选择.html#230-均方误差mean-squared-error-mse)
>
...
* 它的图像如下：
  * ![Logistic函数](/images/机器学习/3.3.2_Logistic函数.png)
  * 它的优势十分明显：
    * 判别规则十分简单
    * 输出了这一判别的概率
    * 连续可导
...
![OvO和OvR的示例](/images/机器学习/3.5_OvO和OvR的示例.png)
...
* 我知道这么说有点懵,那么看看下面的例子：
  * ![ECOC的编码和解码](/images/机器学习/3.5_ECOC的编码和解码.png)

...
![Transformer结构](/images/机器学习/Transformer_Transformer结构图.webp "我相信这个图可能各位都快看吐了，但我还是要贴一下，因为这个图很能说明问题")
...
![Transformer简化结构](/images/机器学习/Transformer_Transformer简化结构图.webp "Transformer简化结构")
...
![Encoder结构](/images/机器学习/Transformer_Encoder结构图.webp "Encoder结构图")
![Encoder简化结构图](/images/机器学习/Transformer_Encoder简化结构图.webp "Encoder简化结构")
...
![Decoder结构](/images/机器学习/Transformer_Decoder结构图.webp "Decoder结构图")
![Decoder简化结构](/images/机器学习/Transformer_Decoder简化结构图.webp "Decoder简化结构图")
...
![Transformer结构](/images/机器学习/Transformer_Transformer结构图.webp)
...
1. 首先就是：Encoder和Decoder都有的这个**$\text{Feed Forward}$**是干嘛的
   ...
   * 从功能上来讲，它的作用是让模型学到更复杂的特征，因为$\text{Multi-Head Attention}$中只是只有**线性变换**(矩阵乘法)，而$\text{Feed Forward}$中有非线性激活函数，能让模型学到更复杂的特征。
    ![一个脑洞大开的表情包](/images/机器学习/Transformer_一个脑洞大开的表情包.webp)
